...
data = cs.load_data("Datasets/ungerichtet/periodic_01/"+file_name)                   # hier nicht vergessen immer die Endungen (zB .txt) zu ändern, wenn oben file_name geändert wird
