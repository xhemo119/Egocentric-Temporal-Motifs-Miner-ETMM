# ich versuche hier bisschen "ETMM.ipynb" nachzubauen, aber mit bar charts
...
S_array = list(S.keys())
print(S_array[10])
print(from_ETNS_to_ETN(S_array[10],k=2,meta=None))
...
for i in range(0,5,fig_per_row):
    ...
    for j in range(fig_per_row):
        ...
        #draw_ETN_barchart(S_array[j],S[S_array[j]])                                        #S_array[] ist der Wert, also z.B. 0b100 und S[S_array[]] ist wie oft das vorkommt, in dem Fall 900
    plt.show()
